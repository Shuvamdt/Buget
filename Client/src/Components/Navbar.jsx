  ...
  return (
    <div>
      <div className="flex-col">
        ...
        {myAccount && (
          <div>
            <div className="fixed font-1 w-40 top-20 h-40 right-5 z-5 rounded-lg bg-[#FAA307]"></div>
          </div>
        )}
        {menuOpen && (
          <div>
            <div className="absolute font-1 flex flex-col items-center w-50 top-0 h-full right-0 z-5 bg-[#E85D04]">
              <div className="md:hidden flex flex-col justify-end px-2 absolute top-5 right-9 z-10">
                <img
                  src="close.png"
                  alt="close icon"
                  className="h-5 w-5"
